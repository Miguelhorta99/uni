...
public class NextLineTrap {
    public static void main(String[] args) {
        ...
        System.out.print("\nEnter a greeting: ");
        scanner.nextLine(); // como o next line tenta apanhar texto e encrontra espaco em branco vai guardar esse espaco como texto, n se quer, por isso se usa um nextLine para deitar fora esse texto
