public class AreaCalculator {
    public static void main(String[] args) {
        ...
        double rectArea = areaRectangle(1, 2);
        ...
        printAreas(squareArea, rectArea, triangleArea, circleArea);
     ...
     */
     ...
     public static void printAreas(double squareArea, double rectArea, double triangleArea, double circleArea){
