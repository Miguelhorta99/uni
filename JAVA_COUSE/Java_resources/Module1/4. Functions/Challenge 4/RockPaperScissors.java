...
public class RockPaperScissors {
    public static void main(String[] args) {
        ...
        if (scan.nextLine().equals("yes")) {
            ...
            String result = result(userChoice, computerChoise);
            printResult(userChoice, computerChoise, result);
     ...
     */
     ...
     public static void printResult(String yourChoise, String computerChoise, String result ){
        System.out.println("You chose: "+ yourChoise);
        System.out.println("The computer chose: "+ computerChoise);
