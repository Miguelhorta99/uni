...
-- user3 / user3Novapass
insert  into my_user (user_name,user_pass,enable) values ('user3','$2a$10$FAHr8O89fBD7uuTLiu9bvuYUh351x9dIbGI/cosILpS17xMlsPgfm',1);
...
insert  into my_user_role (user_name,user_role) values ('user3','ROLE_2');
